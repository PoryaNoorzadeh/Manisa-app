...
final class FavoriteCatalog {
  ...
  bool contains(int nodeId, int endpoint) =>
      outputs.contains(FavoriteOutput(nodeId: nodeId, endpoint: endpoint));
  ...
  factory FavoriteCatalog.fromJson(Map<String, Object?> json) {
    ...
    return FavoriteCatalog(outputs: List<FavoriteOutput>.unmodifiable(outputs));
  }
}
